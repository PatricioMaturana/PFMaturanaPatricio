...
5.	Se aplica deja un selector que permite ver página con diseñor light o dark.
	Para esto se tuvo que mejorar la experiencia del sitio, y para el cambio de colores de acuerdo al tema aplicado se hace a través de variables.
6.	Se utilizo github para guardado de versiones.
7.	Se agrega animación para el logo que se utiliza en el sitio.
8.	Este es el repositorio público del proyecto en github:
	https://github.com/PatricioMaturana/PreEntrega3MaturanaPatricio.git
9.	Este es el GitHub Pages:
